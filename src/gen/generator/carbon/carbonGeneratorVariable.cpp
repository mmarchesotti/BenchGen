...
CarbonGeneratorSortedList::CarbonGeneratorSortedList(int id) {
    this->typeString = "sortedlist_t";
    this->id = id;
    this->name = VarTypes::SORTEDLIST + std::to_string(id);
}

CarbonGeneratorSortedList::~CarbonGeneratorSortedList() {
}

std::vector<std::string> CarbonGeneratorSortedList::genIncludes() {
    std::vector<std::string> temp = {};
    temp.push_back("#include <stdbool.h>");
    return temp;
}

std::vector<std::string> CarbonGeneratorSortedList::new_(bool inFunction) {
...
std::vector<std::string> CarbonGeneratorSortedList::insert() {
    std::vector<std::string> tmp = {};
...
std::vector<std::string> CarbonGeneratorSortedList::remove() {
    std::vector<std::string> tmp = {};
...
std::vector<std::string> CarbonGeneratorSortedList::contains(bool shouldReturn) {
    std::vector<std::string> tmp = {};
    int value = rand() % 100;
...
std::vector<std::string> CarbonGeneratorSortedList::free() {
    std::vector<std::string> tmp = {};
...
std::vector<std::string> CarbonGeneratorSortedList::genGlobalVars() {
    std::vector<std::string> tmp = {};
...
std::vector<std::string> CarbonGeneratorSortedList::genParams(std::string paramName, std::vector<GeneratorVariable*> varsParams) {
    std::vector<std::string> tmp = {};
